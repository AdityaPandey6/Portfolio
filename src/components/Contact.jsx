...
const Contact = () => {
  ...
  return (
    <div ref={containerRef} className='w-full h-screen flex sm:flex-row flex-col justify-between sm:overflow-hidden'>
      {/* Sidebar */}
      <div className='sm:w-1/4 bg-myyellow animate-me'>
        <div className='sm:h-screen h-96 flex flex-col justify-normal p-4'>
          ...
          <pre className='text-lg italic text-center text-gray-900 leading-relaxed mb-40 whitespace-pre-wrap sm:mt-32 pt-6'>
            <span className="sm:hidden sm:p-3 ">There are two hard things in computer science: cache invalidation, naming things.</span>
      ...
      <div className='sm:w-3/4 bg-mygray flex flex-col justify-start items-center'>
        <div className='sm:mt-12 mt-6 sm:h-32 w-4/5 border-dashed border-2 border-gray-500 flex justify-center items-center animate-me'>
          <h1 className='font-title sm:text-8xl text-5xl font-bold text-center'>CONTACT</h1>
        </div>
        <div className='w-4/5 h-full'>
          ...
          <div className='flex sm:flex-row flex-col mt-12 justify-evenly'>
            <div className='flex items-center mt-10 animate-me'>
              <img src="/Assests/Icons/monitor.png" alt="" className='w-32' />
              <h1 className='font-title sm:text-sm text-base ml-4'>8800461596d@gmail.com</h1>
            </div>
            <div className='flex items-center mt-10 animate-me'>
              <img src="/Assests/Icons/telephone.png" alt="" className='w-32' />
              <h1 className='font-title sm:text-2xl text-xl ml-4'>+91 7818957929</h1>
            </div>
          </div>
